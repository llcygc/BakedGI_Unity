...
{
    public abstract class RenderGraphShaderGUI : ShaderGUI
    {
        ...
        public static void SetupMaterialBlendMode(Material material)
        {
            ...
            if (surfaceType == SurfaceType.Opaque)
            {
                ...
                material.DisableKeyword("_FORWARD_CLUSTER_FOG");
                material.renderQueue = -1;
                material.SetShaderPassEnabled("ShadowCaster", true);
            }
            else
            {
                material.EnableKeyword("_FORWARD_CLUSTER_FOG");
            ...
            bool doubleSidedEnable = material.HasProperty("_DoubleSidedEnable") && material.GetFloat("_DoubleSidedEnable") > 0.0f;
            // Disable culling if double sided
            material.SetInt("_Cull", doubleSidedEnable ? (int)UnityEngine.Rendering.CullMode.Off : (int)UnityEngine.Rendering.CullMode.Back);
        }
