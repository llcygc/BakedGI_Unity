...
{
    //public abstract class RenderGraphBaseLitShaderGUI : RenderGraphShaderGUI
    //{
    ...
    //        if ((int)materialID.floatValue == (int)RenderGraphBaseLitShaderGUI.MaterialId.LitSSS)
    //        {
    //            EditorGUI.indentLevel++;
    ...
    //        m_MaterialEditor.ShaderProperty(enableMotionVectorForVertexAnimation, StylesBase.enableMotionVectorForVertexAnimationText);
    ...
    //        //if ((int)material.GetFloat(kMaterialID) == (int)RenderGraphBaseLitShaderGUI.MaterialId.LitSSS)
    //        //{
    ...
    //    {
    //        SetupBaseMaterialPass(material);
    //    }
