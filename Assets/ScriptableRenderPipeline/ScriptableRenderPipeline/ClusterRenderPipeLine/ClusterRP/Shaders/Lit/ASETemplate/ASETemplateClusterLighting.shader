Shader /*ase_name*/ "ASETemplateShaders/ClusterLighting" /*end*/
{
	Properties
	{
        /*ase_props*/
        ...
        SubShader
    {
        ...
        /*ase_pragma*/
			...
			half4 frag (v2f i /*ase_frag_input*/) : SV_Target
			{
                ...
                surfData.alpha =  /*ase_frag_out:Alpha;Float;_Alpha*/1/*end*/;
		...
		Pass
		{
			...
			half4 frag (v2f i /*ase_frag_input*/) : SV_Target
			{
                ...
                half alpha = /*ase_frag_out:Alpha;Float;_Alpha*/1/*end*/;
