...
{
    float2 unlitColorMapUv = TRANSFORM_TEX(input.texCoord0, _MainTex);
    surfaceData.color = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, unlitColorMapUv).rgb * _UnlitColor.rgb;
    float alpha = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, unlitColorMapUv).a * _UnlitColor.a;
