...
namespace Viva.Rendering.RenderGraph.ClusterPipeline
{
    public class ClusterRenderPipeline : RenderPipeline
    {
        ...
        public ClusterRenderPipeline(ClusterRenderPipeLineAsset asset)
        {
            ...
            m_CameraColorBuffer = RTHandles.Alloc(width: frameWidth, height: frameHeight, filterMode: FilterMode.Point, colorFormat: RenderTextureFormat.RGB111110Float, sRGB: false, msaaSamples: frameMsaaSamples, enableRandomWrite: true, name: "CameraColor");
            ...
            if (NeedDepthBufferCopy())
            {
                ...
                m_CameraColorBufferCopy = RTHandles.Alloc(width: frameWidth, height: frameHeight, filterMode: FilterMode.Bilinear, colorFormat: RenderTextureFormat.RGB111110Float, sRGB: false, msaaSamples: frameMsaaSamples, enableRandomWrite: false, name: "CameraColorCopy");
            }
        ...
        private void ReallocateAllRenderTargets()
        {
            ...
            m_CameraColorBuffer = RTHandles.Alloc(width: rtC.frameWidth, height: rtC.frameHeight, filterMode: FilterMode.Point, colorFormat: RenderTextureFormat.RGB111110Float, sRGB: false, enableRandomWrite: true, dimension: rtC.textureDimension, slices: texArraySlices, msaaSamples: rtC.msaaSamples, name: "CameraColor");
