...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    public sealed class TemporalAntialiasing
    {
        ...
        internal void Render(PostProcessRenderContext context)
        {
            ...
            if (true/*XR.XRSettings.eyeTextureDesc.dimension == TextureDimension.Tex2DArray*/)
            {
                pass = (int)Pass.SolverDilateDestination;
                cmd.BlitFullscreenTriangle(context.source, context.destination, sheet, pass);
                cmd.BlitFullscreenTriangle(context.destination, historyWrite, RuntimeUtilities.copySheet, 1);
                cmd.SetRenderTarget(context.destination, 0, CubemapFace.Unknown, -1);
