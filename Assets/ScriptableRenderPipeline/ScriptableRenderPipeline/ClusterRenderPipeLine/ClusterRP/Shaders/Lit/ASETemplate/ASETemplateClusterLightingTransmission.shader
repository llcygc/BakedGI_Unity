Shader /*ase_name*/ "ASETemplateShaders/ClusterLightingTransmission" /*end*/
{
	Properties
	{
        /*ase_props*/
        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            #include "ClusterRP/Shaders/Lit/ASETemplate/ClusterLightingTrans.hlsl"
        /*ase_pragma*/
			...
			struct v2f
			{
				...
				/*ase_interp(9,12):sp=sp.xyzw;uv0=tc0.xy;uv1=tc0.zw;wp=tc2;wn=tc3;wt=tc4;wvd=tc6;c=c*/
			};
			...
			half4 frag (v2f i /*ase_frag_input*/) : SV_Target
			{
                ...
                half3 transmission = /*ase_frag_out:Transmission;Float3*/half3(0, 0, 0)/*end*/;
                half3 translucency = /*ase_frag_out:Translucency;Float3*/half3(0, 0, 0)/*end*/;
...
#endif
                half3 ambient = brdfDataIndirect.bakedGI * surfData.occlusion;
#ifdef SCREEN_SHADOW
                int3 screenCoord = int3((i.screenPos.xy / i.screenPos.w) * _ScreenSize, sliceIndex);
                color.rgb += Surface_ClusterLightingResult_Direct_Trans_OP(brdfDataDirect.diffuse, brdfDataDirect.specular, brdfDataDirect.roughness, brdfDataDirect.roughness2, transmission, translucency, ambient, screenCoord, inputData.normalWS, inputData.viewDirectionWS, inputData.positionWS, inputData.clusterId);
#else
                color.rgb += Surface_ClusterLightingResult_Direct_Trans_OP(brdfDataDirect.diffuse, brdfDataDirect.specular, brdfDataDirect.roughness, brdfDataDirect.roughness2, transmission, translucency, ambient, inputData.normalWS, inputData.viewDirectionWS, inputData.positionWS, inputData.clusterId);
#endif
                return color;
			}
			ENDHLSL
		...
		Pass
		{
			...
			struct v2f
			{
                ...
                UNITY_VERTEX_INPUT_INSTANCE_ID
                UNITY_VERTEX_OUTPUT_STEREO
				/*ase_interp(9,12):sp=sp.xyzw;uv0=tc0.xy;uv1=tc0.zw;*/
			};
