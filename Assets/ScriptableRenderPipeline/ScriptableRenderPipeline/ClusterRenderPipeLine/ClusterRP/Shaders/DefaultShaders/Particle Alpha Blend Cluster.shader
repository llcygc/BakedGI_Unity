...
Shader "Viva/Particles/Alpha Blended" {
Properties {
    ...
    SubShader {
        Pass {
            ...
            v2f vert (appdata_t v)
            {
                ...
                o.clusterPos = ComputeClusterPos(float4(posWS.xyz, 1.0f), Cluster_Matrix_LinearZ);
                #ifdef SOFTPARTICLES_ON
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                half3 clusterUV = ComputeClusterUV(i.clusterPos);
                half4 scatteringColor = SAMPLE_TEXTURE3D_LOD(_VolumetricFogTexture, sampler_VolumetricFogTexture, clusterUV, 0);
                //col.rgb = scatteringColor.rgb + col.rgb * scatteringColor.a;
