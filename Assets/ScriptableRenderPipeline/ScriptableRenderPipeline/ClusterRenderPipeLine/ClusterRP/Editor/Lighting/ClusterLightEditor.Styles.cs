...
{
    partial class ClusterLightEditor
    {
        sealed class Styles
        {
            // Base
            ...
            public readonly GUIContent shadowUpdateType = new GUIContent("Shadow Update Method", "Dynamic: Update every frame. Static: Do not update. Hybrid: Only update when necessery.");
            public readonly GUIContent useStaticShadowmapForLastCascade = new GUIContent("Static Shadowmap for Last Cascade", "The shadow map of last cascade is static");
