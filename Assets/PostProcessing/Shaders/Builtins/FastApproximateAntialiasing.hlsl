...
struct FxaaTex { SamplerState smpl; Texture2DArray tex; };
#define FxaaTexTop(t, p) t.tex.SampleLevel(t.smpl, float3(UnityStereoTransformScreenSpaceTex(p).xy, unity_StereoEyeIndex), 0.0)
#define FxaaTexOff(t, p, o, r) t.tex.SampleLevel(t.smpl, float3(UnityStereoTransformScreenSpaceTex(p).xy, unity_StereoEyeIndex), 0.0, o)
#else
...
struct FxaaTex { SamplerState smpl; Texture2DArray tex; };
#define FxaaTexTop(t, p) t.tex.SampleLevel(t.smpl, float3(UnityStereoTransformScreenSpaceTex(p).xy, unity_StereoEyeIndex), 0.0)
#define FxaaTexOff(t, p, o, r) t.tex.SampleLevel(t.smpl, float3(UnityStereoTransformScreenSpaceTex(p), unity_StereoEyeIndex), 0.0, o)
#define FxaaTexAlpha4(t, p) t.tex.GatherAlpha(t.smpl, float3(UnityStereoTransformScreenSpaceTex(p), unity_StereoEyeIndex))
#define FxaaTexOffAlpha4(t, p, o) t.tex.GatherAlpha(t.smpl, float3(UnityStereoTransformScreenSpaceTex(p), unity_StereoEyeIndex), o)
#define FxaaTexGreen4(t, p) t.tex.GatherGreen(t.smpl, float3(UnityStereoTransformScreenSpaceTex(p), unity_StereoEyeIndex))
#define FxaaTexOffGreen4(t, p, o) t.tex.GatherGreen(t.smpl, float3(UnityStereoTransformScreenSpaceTex(p), unity_StereoEyeIndex), o)
#else
struct FxaaTex { SamplerState smpl; Texture2D tex; };
#define FxaaTexTop(t, p) t.tex.SampleLevel(t.smpl, UnityStereoTransformScreenSpaceTex(p), 0.0)
#define FxaaTexOff(t, p, o, r) t.tex.SampleLevel(t.smpl, UnityStereoTransformScreenSpaceTex(p), 0.0, o)
